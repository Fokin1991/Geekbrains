...
2. [Пошаговая инструкция  по работе  с удаленными  репозиториями](#2-пошаговая-инструкция-по-работе-с-удаленными-репозиториями)
...
### 2. [Пошаговая инструкция  по работе  с удаленными  репозиториями](#глава-третья)

<br>
<br>

![Repositories](instructions_for_working_with_repositories.jpg)
